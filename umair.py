...
def UMAIR_MAIN(
    ...
    if(MISSING_FOB_PERCENTAGE<=0.3 or MISSING_FOB_PERCENTAGE<=MISSING_CIF_PERCENTAGE):
    ...
    final_data=grouped_df[['ARRIVAL DATE',
                       'HS CODE',
                       'HS CODE DESCRIPTION',
                       'IMPORTER NAME',
                       'IMPORTER ADDRESS',
                       ...
                       'PER_BOX_GROSS_WEIGHT',
                       'PER_PCE_NET_WEIGHT',
                       'PER_BOX_NET_WEIGHT',
                       'PER_PCE_UNIT_PRICE',
                       'PER_BOX_UNIT_PRICE',
                       'EQUAL_VOLUMES',
                       'PCE_NET_WEIGHT_CHECK',
                       'PCE_GROSS_WEIGHT_CHECK',
                       'BOX_NET_WEIGHT_CHECK',
                       'BOX_GROSS_WEIGHT_CHECK',
                       'PCE_PRICE_CHECK',
                       'BOX_PRICE_CHECK',
                       'PCE_COUNT_IGNORE',
                       'BOX_COUNT_IGNORE',
